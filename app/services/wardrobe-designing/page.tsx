...
const galleryImages = [
  {
    ...
    alt: "Elegant sage green wardrobe with brass handles and clean lines",
  },
  {
    src: "/images/wardrobe6.jpg",
    alt: "Modern walk-in wardrobe with LED lighting and mixed materials",
  },
  {
    src: "/images/wardrobe4.jpg",
    alt: "Contemporary wardrobe with fluted wood panels and circular handles",
  },
  {
    src: "/images/wardrobe7.jpg",
    alt: "Sophisticated bedroom wardrobe with wood and white combination",
  },
  {
    src: "/images/wardrobe5.jpg",
    alt: "Minimalist wardrobe design with geometric patterns and black accents",
  },
  {
    src: "/images/wardrobe.jpg",
    alt: "Classic wardrobe with wooden base and circular wooden handles",
  },
  {
    src: "/images/wardrobe9.jpg",
    alt: "Modern wardrobe with integrated dressing table and mirror",
  },
  {
    src: "/images/wardrobe8.jpg",
    alt: "Floor-to-ceiling wardrobe with open shelving display section",
  },
  {
    src: "/images/wardrobe2.jpg",
    alt: "Luxury wardrobe with arched doors and fluted wood details",
  },
  {
    src: "/images/wardrobe1.jpg",
    alt: "Traditional style wardrobe with brass hardware and panel doors",
  },
]
...
const features = [
  {
    title: "Custom Design",
    description: "Tailored to your specific space and storage needs",
    icon: <Check className="h-5 w-5 text-blue-500" />,
  },
  {
    title: "Premium Materials",
    description: "High-quality materials that ensure durability and elegance",
    icon: <Check className="h-5 w-5 text-blue-500" />,
  },
  {
  ...
  },
  {
    ...
    description: "Expert installation by our skilled craftsmen",
    icon: <Check className="h-5 w-5 text-blue-500" />,
  },
  {
...
export default function WardrobeDesigning() {
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 md:pr-12">
              ...
              <p className="text-xl text-slate-600 mb-8 leading-relaxed">
                Transform your storage space with our custom designer wardrobe solutions. We design and build wardrobes
                that perfectly fit your space while keeping your belongings organized and accessible.
              </p>
              <div className="flex flex-wrap gap-4 mb-8">
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mr-2"></div>
                  <span className="text-slate-700">Custom Fit</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mr-2"></div>
                  <span className="text-slate-700">Organized Storage</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mr-2"></div>
                  <span className="text-slate-700">Premium Hardware</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mr-2"></div>
                  <span className="text-slate-700">Elegant Design</span>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">
              Our Designer Wardrobe Features
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              We combine functionality with aesthetics to create wardrobes that enhance your space and lifestyle
            </p>
          </div>
      ...
      <section id="gallery" className="py-20 px-4 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">
              Our Designer Wardrobe Gallery
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Explore our collection of custom wardrobe designs we've created for our clients
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <p className="text-slate-600 leading-relaxed">
                Our wardrobe design process begins with understanding your specific needs and space constraints. We then
                create custom designs that maximize storage while complementing your interior aesthetic.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      We meet to discuss your requirements, preferences, and budget constraints.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      Our designers create detailed plans and 3D visualizations of your custom wardrobe.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      We craft your wardrobe using premium materials and precision manufacturing techniques.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      Our expert team installs your wardrobe with precision and attention to detail.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 px-4 bg-slate-900 text-white">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Transform Your Storage with Designer Wardrobe?
          </h2>
          <p className="text-xl text-slate-300 mb-10 max-w-3xl mx-auto">
            Contact us today to schedule a consultation and get started on your custom wardrobe design project.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-slate-400 mb-4">
                Luxury Interior Design Studio specializing in custom wardrobe solutions.
              </p>
            </div>
            <div>
