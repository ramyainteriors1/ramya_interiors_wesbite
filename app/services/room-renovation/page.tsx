...
const galleryImages = [
  {
    ...
    alt: "Modern bedroom with illuminated wooden slat headboard and floating nightstands",
  },
  {
    src: "/images/bedroom2.jpg",
    alt: "Luxurious bedroom with curved wooden slat feature wall and LED backlighting",
  },
  {
    src: "/images/bedroom3.jpg",
    alt: "Serene bedroom with artistic tree branch wall art and warm ambient lighting",
  },
  {
    src: "/images/bedroom4.jpg",
    alt: "Elegant bedroom with arched headboard niche and botanical wallpaper",
  },
  {
    src: "/images/bedroom5.jpg",
    alt: "Sophisticated bedroom with classical paneled walls and modern chandelier",
  },
  {
    src: "/images/bedroom6.jpg",
    alt: "Contemporary bedroom with orange leather headboard and white paneled walls",
  },
  {
    src: "/images/bedroom.jpg",
    alt: "Minimalist bedroom with wooden slat accent wall and modern lighting",
  },
]
...
const features = [
  {
    ...
    description: "Full room makeovers from floor to ceiling with attention to every detail",
  ...
  },
  {
    ...
    description: "Project completion within agreed timelines without compromising quality",
    icon: <Check className="h-5 w-5 text-blue-500" />,
  },
  {
    title: "Design Consultation",
    description: "Expert guidance throughout the renovation process",
    icon: <Check className="h-5 w-5 text-blue-500" />,
  },
  {
    title: "Post-Completion Support",
    description: "Ongoing support and maintenance guidance after project completion",
    icon: <Check className="h-5 w-5 text-blue-500" />,
  },
]

export default function RoomRenovation() {
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 md:pr-12">
              ...
              <p className="text-xl text-slate-600 mb-8 leading-relaxed">
                Complete room makeovers that breathe new life into your living spaces. From concept to completion, we
                handle every detail of your renovation with precision and care.
              </p>
              <div className="flex flex-wrap gap-4 mb-8">
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mr-2"></div>
                  <span className="text-slate-700">Complete Makeover</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mr-2"></div>
                  <span className="text-slate-700">Space Planning</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mr-2"></div>
                  <span className="text-slate-700">Quality Materials</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mr-2"></div>
            ...
            <div className="md:w-1/2 mt-12 md:mt-0">
              <div className="relative rounded-lg overflow-hidden shadow-2xl">
                <img
                  src="/images/bedroom1.jpg"
                  alt="Modern bedroom with illuminated wooden slat headboard"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">
              Our Room Design Features
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              We transform your rooms with comprehensive renovation services that enhance both beauty and functionality
            </p>
          </div>
      ...
      <section id="gallery" className="py-20 px-4 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">
              Our Room Design Gallery
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Explore our collection of stunning room renovations we've completed for our clients
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <p className="text-slate-600 leading-relaxed">
                Our room renovation process is designed to minimize disruption while maximizing transformation. We work
                closely with you to understand your vision and bring it to life with expert craftsmanship.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-slate-800">Initial Assessment</h4>
                    <p className="text-slate-600">
                      We evaluate your current space and discuss your renovation goals and budget.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-slate-800">Design Development</h4>
                    <p className="text-slate-600">
                      Our team creates detailed renovation plans and 3D visualizations for your approval.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-slate-800">Execution</h4>
                    <p className="text-slate-600">
                      We execute the renovation with skilled craftsmen and quality materials.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      We add finishing touches and ensure every detail meets our high standards.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 px-4 bg-slate-900 text-white">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Transform Your Room?</h2>
          <p className="text-xl text-slate-300 mb-10 max-w-3xl mx-auto">
            Contact us today to schedule a consultation and get started on your room renovation project.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-slate-400 mb-4">
                Luxury Interior Design Studio specializing in room renovation solutions.
              </p>
            </div>
            <div>
